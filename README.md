...
| <!-- -->                                                        	| <!-- -->                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       	|
|-----------------------------------------------------------------	|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| Can I test the CloudFormation Guard code outside of AWS Config? 	| Unit testing can be done locally on your local device or something like Cloud9<br><br>Installation steps can be found here: <br>https://github.com/aws-cloudformation/cloudformation-guard#guard-cli<br> <br>Once the CloudFormation Guard app is downloaded and installed with the dependencies the policy can be run against a local deployment of CloudFormation Guard on a laptop or virtual machine to validate if the cfn-guard syntax is correct.  All that is needed is a test sample of JSON saved as a text file and the cfn-guard policy.<br> <br>cfn-guard CLI command:<br> <br>cfn-guard validate -d /home/ubuntu/cfng/templates/vol-json.txt -r /home/ubuntu/cfng/rulesets/ec2-volume-config.txt 	|
| How can I debug my AWS Config Custom rule use cfn-guard?        	| The Boolean expression for enabling debug logging for your AWS Config Custom Policy rule. The default value is false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          	|